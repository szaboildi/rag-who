...
def setup_vector_db(
    encoder_name: str = "intfloat/e5-base",
    client_source: str = ":memory:",
    qdrant_cloud_api_key: str = "None",
    ...
    if mode == "qdrant":
        ...
        if client_source == ":memory":
            ...
            client = QdrantClient(url=client_source, api_key=qdrant_cloud_api_key)
        ...
        for file_name in file_names:
            ...
            input_passages_dict = process_text(
                file_name,
                length=chunk_length,
                words_overlap=chunk_overlap_words,
                return_format="ls_dict",
                input_folder_qa=input_folder_qa,
        ...
        if dist_name.lower() == "cosine":
            ...
            dist_name.lower() == "dot"
            or dist_name.lower() == "dotproduct"
            or dist_name.lower() == "dot_product"
        ):
        ...
        document_store = InMemoryDocumentStore(embedding_similarity_function=dist_name)
